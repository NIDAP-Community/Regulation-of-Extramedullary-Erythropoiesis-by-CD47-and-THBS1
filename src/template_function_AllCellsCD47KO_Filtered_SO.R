...
AllCellsCD47KO_Filtered_SO <- function(AllCellsCd34PosNeg_DualLabel_SO, AllCellsCd34PosNeg_DualLabel_MetadataTable, AllCellsCd34PosNeg_DualLabel_SampleNames) {
...
print("template_function_AllCellsCD47KO_Filtered_SO.R #########################################################################")
...
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_AllCellsCd34PosNeg_DualLabel_MetadataTable<-NULL #(paste0(rds_output,"/var_AllCellsCd34PosNeg_DualLabel_MetadataTable.rds"))
...
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_AllCellsCd34PosNeg_DualLabel_SampleNames<-NULL #(paste0(rds_output,"/var_AllCellsCd34PosNeg_DualLabel_SampleNames.rds"))
Input_is_Seurat_count <- 0
...
var_AllCellsCD47KO_Filtered_SO<-AllCellsCD47KO_Filtered_SO(var_AllCellsCd34PosNeg_DualLabel_SO,var_AllCellsCd34PosNeg_DualLabel_MetadataTable,var_AllCellsCd34PosNeg_DualLabel_SampleNames)
invisible(graphics.off())
saveRDS(var_AllCellsCD47KO_Filtered_SO, paste0(rds_output,"/var_AllCellsCD47KO_Filtered_SO.rds"))
