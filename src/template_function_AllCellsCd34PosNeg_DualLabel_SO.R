...
AllCellsCd34PosNeg_DualLabel_SO <- function(ccbr1072_SuppFig7b,AllCells_CellTypes_SampleNames) {  # produces 2 color channels and the overlay
    ...
    #Primary inputs:
    seurat_object <- ccbr1072_SuppFig7b
...
print("template_function_AllCellsCd34PosNeg_DualLabel_SO.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_ccbr1072_SuppFig7b<-readRDS(paste0(rds_output,"/var_ccbr1072_SuppFig7b.rds"))
Input_is_Seurat_count <- 1
#for(item in var_ccbr1072_SuppFig7b){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_ccbr1072_SuppFig7b<-as.data.frame(var_ccbr1072_SuppFig7b)}else{var_ccbr1072_SuppFig7b <- var_ccbr1072_SuppFig7b}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
...
var_AllCellsCd34PosNeg_DualLabel_SO<-AllCellsCd34PosNeg_DualLabel_SO(var_ccbr1072_SuppFig7b,var_AllCells_CellTypes_SampleNames)
invisible(graphics.off())
saveRDS(var_AllCellsCd34PosNeg_DualLabel_SO, paste0(rds_output,"/var_AllCellsCd34PosNeg_DualLabel_SO.rds"))
