# Subset Seurat Object [scRNA-Seq][CCBR] (ec3f23f9-bcba-4f3a-8a08-8ba611fbb6c7): v146
AllCellsWT_Filtered_SO_20240326 <- function(AllCellsCd34PosNeg_DualLabel_SO, AllCellsCd34PosNeg_DualLabel_MetadataTable, AllCellsCd34PosNeg_DualLabel_SampleNames) {
...
library(plotly)
    ...
    seurat_object <- AllCellsCd34PosNeg_DualLabel_SO
    
    # Category parameters    
    category_to_filter <- "Treatment_Group"
    seed <- 10
    ...
    colors <- c("aquamarine3","salmon1","plum3")
...
print("template_function_AllCellsWT_Filtered_SO_20240326.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_AllCellsCd34PosNeg_DualLabel_SO<-readRDS(paste0(rds_output,"/var_AllCellsCd34PosNeg_DualLabel_SO.rds"))
Input_is_Seurat_count <- 1
#for(item in var_AllCellsCd34PosNeg_DualLabel_SO){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_AllCellsCd34PosNeg_DualLabel_SO<-as.data.frame(var_AllCellsCd34PosNeg_DualLabel_SO)}else{var_AllCellsCd34PosNeg_DualLabel_SO <- var_AllCellsCd34PosNeg_DualLabel_SO}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
#var_AllCellsCd34PosNeg_DualLabel_MetadataTable<-readRDS(paste0(rds_output,"/var_AllCellsCd34PosNeg_DualLabel_MetadataTable.rds"))
var_AllCellsCd34PosNeg_DualLabel_MetadataTable<-NULL
Input_is_Seurat_count <- 0
#for(item in var_AllCellsCd34PosNeg_DualLabel_MetadataTable){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_AllCellsCd34PosNeg_DualLabel_MetadataTable<-as.data.frame(var_AllCellsCd34PosNeg_DualLabel_MetadataTable)}else{var_AllCellsCd34PosNeg_DualLabel_MetadataTable <- var_AllCellsCd34PosNeg_DualLabel_MetadataTable}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
#var_AllCellsCd34PosNeg_DualLabel_SampleNames<-readRDS(paste0(rds_output,"/var_AllCellsCd34PosNeg_DualLabel_SampleNames.rds"))
var_AllCellsCd34PosNeg_DualLabel_SampleNames<-NULL
Input_is_Seurat_count <- 0
#for(item in var_AllCellsCd34PosNeg_DualLabel_SampleNames){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_AllCellsCd34PosNeg_DualLabel_SampleNames<-as.data.frame(var_AllCellsCd34PosNeg_DualLabel_SampleNames)}else{var_AllCellsCd34PosNeg_DualLabel_SampleNames <- var_AllCellsCd34PosNeg_DualLabel_SampleNames}
invisible(graphics.off())
var_AllCellsWT_Filtered_SO_20240326<-AllCellsWT_Filtered_SO_20240326(var_AllCellsCd34PosNeg_DualLabel_SO,var_AllCellsCd34PosNeg_DualLabel_MetadataTable,var_AllCellsCd34PosNeg_DualLabel_SampleNames)
invisible(graphics.off())
saveRDS(var_AllCellsWT_Filtered_SO_20240326, paste0(rds_output,"/var_AllCellsWT_Filtered_SO_20240326.rds"))
