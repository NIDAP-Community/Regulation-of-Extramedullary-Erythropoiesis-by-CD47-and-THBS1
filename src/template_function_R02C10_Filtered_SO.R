...
R02C10_Filtered_SO <- function(AllCellsCd34PosNeg_DualLabel_SO, AllCellsCd34PosNeg_DualLabel_MetadataTable, AllCellsCd34PosNeg_DualLabel_SampleNames) {
...
library(plotly)
    ...
    cut_off <- 0.5
    category_to_filter <- "SCT_snn_res_0_2"
    legend_position <- "right"
    values_to_filter <- c("10")
    reduction <- "tsne"
...
print("template_function_R02C10_Filtered_SO.R #########################################################################")
...
var_R02C10_Filtered_SO<-R02C10_Filtered_SO(var_AllCellsCd34PosNeg_DualLabel_SO,var_AllCellsCd34PosNeg_DualLabel_MetadataTable,var_AllCellsCd34PosNeg_DualLabel_SampleNames)
invisible(graphics.off())
saveRDS(var_R02C10_Filtered_SO, paste0(rds_output,"/var_R02C10_Filtered_SO.rds"))
