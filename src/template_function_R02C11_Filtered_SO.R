...
R02C11_Filtered_SO <- function(AllCellsCd34PosNeg_DualLabel_SO, AllCellsCd34PosNeg_DualLabel_MetadataTable, AllCellsCd34PosNeg_DualLabel_SampleNames) {
...
print("template_function_R02C11_Filtered_SO.R #########################################################################")
...
var_R02C11_Filtered_SO<-R02C11_Filtered_SO(var_AllCellsCd34PosNeg_DualLabel_SO,var_AllCellsCd34PosNeg_DualLabel_MetadataTable,var_AllCellsCd34PosNeg_DualLabel_SampleNames)
invisible(graphics.off())
saveRDS(var_R02C11_Filtered_SO, paste0(rds_output,"/var_R02C11_Filtered_SO.rds"))
