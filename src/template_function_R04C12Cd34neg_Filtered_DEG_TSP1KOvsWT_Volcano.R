...
R04C12Cd34neg_Filtered_DEG_TSP1KOvsWT_Volcano <- function(R04C12Cd34neg_Filtered_DEG) {
    # image: png
...
#CHANGE LOG (NW 2022-03-22): Export significant counts to output log, remove from plot title (~line 160)
    ...
    png(
      filename="R04C12Cd34neg_Filtered_DEG_TSP1KOvsWT_Volcano.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_function_R04C12Cd34neg_Filtered_DEG_TSP1KOvsWT_Volcano.R #########################################################################")
...
var_R04C12Cd34neg_Filtered_DEG_TSP1KOvsWT_Volcano<-R04C12Cd34neg_Filtered_DEG_TSP1KOvsWT_Volcano(var_R04C12Cd34neg_Filtered_DEG)
invisible(graphics.off())
saveRDS(var_R04C12Cd34neg_Filtered_DEG_TSP1KOvsWT_Volcano, paste0(rds_output,"/var_R04C12Cd34neg_Filtered_DEG_TSP1KOvsWT_Volcano.rds"))
