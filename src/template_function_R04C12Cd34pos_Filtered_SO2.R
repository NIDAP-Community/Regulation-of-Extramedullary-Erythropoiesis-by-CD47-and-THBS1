...
R04C12Cd34pos_Filtered_SO2 <- function(R04C12Cd34pos_Filtered_SO, R04C12Cd34pos_Filtered_MetadataTable, R04C12_Filtered_SampleNames) {
...
library(plotly)
    ...
    seurat_object <- R04C12Cd34pos_Filtered_SO
...
print("template_function_R04C12Cd34pos_Filtered_SO2.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_R04C12Cd34pos_Filtered_SO<-readRDS(paste0(rds_output,"/var_R04C12Cd34pos_Filtered_SO.rds"))
Input_is_Seurat_count <- 1
#for(item in var_R04C12Cd34pos_Filtered_SO){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_R04C12Cd34pos_Filtered_SO<-as.data.frame(var_R04C12Cd34pos_Filtered_SO)}else{var_R04C12Cd34pos_Filtered_SO <- var_R04C12Cd34pos_Filtered_SO}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_R04C12Cd34pos_Filtered_MetadataTable<-NULL #(paste0(rds_output,"/var_R04C12Cd34pos_Filtered_MetadataTable.rds"))
Input_is_Seurat_count <- 0
#for(item in var_R04C12Cd34pos_Filtered_MetadataTable){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_R04C12Cd34pos_Filtered_MetadataTable<-as.data.frame(var_R04C12Cd34pos_Filtered_MetadataTable)}else{var_R04C12Cd34pos_Filtered_MetadataTable <- var_R04C12Cd34pos_Filtered_MetadataTable}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
...
var_R04C12Cd34pos_Filtered_SO2<-R04C12Cd34pos_Filtered_SO2(var_R04C12Cd34pos_Filtered_SO,var_R04C12Cd34pos_Filtered_MetadataTable,var_R04C12_Filtered_SampleNames)
invisible(graphics.off())
saveRDS(var_R04C12Cd34pos_Filtered_SO2, paste0(rds_output,"/var_R04C12Cd34pos_Filtered_SO2.rds"))
