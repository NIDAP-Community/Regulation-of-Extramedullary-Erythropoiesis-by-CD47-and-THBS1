...
R04C12DEG_TSP1KOvsWT_GSEA <- function(R04C12_DEG_Volcano_TSP1KOvsWT, GSEA_MSigDB_v6_2_with_Orthologs_CCBR_) {
...
# Primary inputs
deg_table = R04C12_DEG_Volcano_TSP1KOvsWT
...
#image: png
png(
  filename = "R04C12DEG_TSP1KOvsWT_GSEA.png",
  width = image_width,
  height = image_height,
  units = "px",
  pointsize = 4,
...
print("template_function_R04C12DEG_TSP1KOvsWT_GSEA.R #########################################################################")
...
var_R04C12DEG_TSP1KOvsWT_GSEA<-R04C12DEG_TSP1KOvsWT_GSEA(var_R04C12_DEG_Volcano_TSP1KOvsWT,var_GSEA_MSigDB_v6_2_with_Orthologs_CCBR_)
invisible(graphics.off())
saveRDS(var_R04C12DEG_TSP1KOvsWT_GSEA, paste0(rds_output,"/var_R04C12DEG_TSP1KOvsWT_GSEA.rds"))
