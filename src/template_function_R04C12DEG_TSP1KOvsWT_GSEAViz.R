...
R04C12DEG_TSP1KOvsWT_GSEAViz <- function(R04C12_DEG_Volcano_TSP1KOvsWT, R04C12DEG_TSP1KOvsWT_GSEA, R04C12_Filtered_DEG, R04C12_Filtered_MetadataTable, GSEA_MSigDB_v6_2_with_Orthologs_CCBR_) {
...
## PARAMETERS
    ...
    genescore_df <- R04C12_DEG_Volcano_TSP1KOvsWT
    gex_df <- R04C12_Filtered_DEG
    metadata_df <- R04C12_Filtered_MetadataTable
    gsea_df <- R04C12DEG_TSP1KOvsWT_GSEA
...
png(filename="R04C12DEG_TSP1KOvsWT_GSEAViz.png", width=(pageWidth+5)*300, height=(pageHeight+5)*300, units="px", pointsize=4, bg="white", res=300, type="cairo") 
print(preview)
...
print("template_function_R04C12DEG_TSP1KOvsWT_GSEAViz.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_R04C12_DEG_Volcano_TSP1KOvsWT<-readRDS(paste0(rds_output,"/var_R04C12_DEG_Volcano_TSP1KOvsWT.rds"))
Input_is_Seurat_count <- 0
#for(item in var_R04C12_DEG_Volcano_TSP1KOvsWT){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_R04C12_DEG_Volcano_TSP1KOvsWT<-as.data.frame(var_R04C12_DEG_Volcano_TSP1KOvsWT)}else{var_R04C12_DEG_Volcano_TSP1KOvsWT <- var_R04C12_DEG_Volcano_TSP1KOvsWT}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_R04C12DEG_TSP1KOvsWT_GSEA<-readRDS(paste0(rds_output,"/var_R04C12DEG_TSP1KOvsWT_GSEA.rds"))
Input_is_Seurat_count <- 0
#for(item in var_R04C12DEG_TSP1KOvsWT_GSEA){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_R04C12DEG_TSP1KOvsWT_GSEA<-as.data.frame(var_R04C12DEG_TSP1KOvsWT_GSEA)}else{var_R04C12DEG_TSP1KOvsWT_GSEA <- var_R04C12DEG_TSP1KOvsWT_GSEA}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_R04C12_Filtered_DEG<-readRDS(paste0(rds_output,"/var_R04C12_Filtered_DEG.rds"))
Input_is_Seurat_count <- 0
#for(item in var_R04C12_Filtered_DEG){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_R04C12_Filtered_DEG<-as.data.frame(var_R04C12_Filtered_DEG)}else{var_R04C12_Filtered_DEG <- var_R04C12_Filtered_DEG}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
...
var_R04C12DEG_TSP1KOvsWT_GSEAViz<-R04C12DEG_TSP1KOvsWT_GSEAViz(var_R04C12_DEG_Volcano_TSP1KOvsWT,var_R04C12DEG_TSP1KOvsWT_GSEA,var_R04C12_Filtered_DEG,var_R04C12_Filtered_MetadataTable,var_GSEA_MSigDB_v6_2_with_Orthologs_CCBR_)
invisible(graphics.off())
saveRDS(var_R04C12DEG_TSP1KOvsWT_GSEAViz, paste0(rds_output,"/var_R04C12DEG_TSP1KOvsWT_GSEAViz.rds"))
