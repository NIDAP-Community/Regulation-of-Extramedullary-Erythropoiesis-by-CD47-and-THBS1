...
R04C12_DEG_Volcano_CD47KOvsWT <- function(R04C12_Filtered_DEG) {
    # image: png
...
#CHANGE LOG (NW 2022-03-22): Export significant counts to output log, remove from plot title (~line 160)
    ...
    png(
      filename="R04C12_DEG_Volcano_CD47KOvsWT.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_function_R04C12_DEG_Volcano_CD47KOvsWT.R #########################################################################")
...
var_R04C12_DEG_Volcano_CD47KOvsWT<-R04C12_DEG_Volcano_CD47KOvsWT(var_R04C12_Filtered_DEG)
invisible(graphics.off())
saveRDS(var_R04C12_DEG_Volcano_CD47KOvsWT, paste0(rds_output,"/var_R04C12_DEG_Volcano_CD47KOvsWT.rds"))
