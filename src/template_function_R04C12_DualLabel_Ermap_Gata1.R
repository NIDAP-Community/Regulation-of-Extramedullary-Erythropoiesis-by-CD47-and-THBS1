...
R04C12_DualLabel_Ermap_Gata1 <- function(R04C12_DualLabel_Klf1_Gata1,R04C12_Filtered_SampleNames) {  # produces 2 color channels and the overlay
    ...
    #Primary inputs:
    seurat_object <- R04C12_DualLabel_Klf1_Gata1
...
print("template_function_R04C12_DualLabel_Ermap_Gata1.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_R04C12_DualLabel_Klf1_Gata1<-readRDS(paste0(rds_output,"/var_R04C12_DualLabel_Klf1_Gata1.rds"))
Input_is_Seurat_count <- 1
#for(item in var_R04C12_DualLabel_Klf1_Gata1){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_R04C12_DualLabel_Klf1_Gata1<-as.data.frame(var_R04C12_DualLabel_Klf1_Gata1)}else{var_R04C12_DualLabel_Klf1_Gata1 <- var_R04C12_DualLabel_Klf1_Gata1}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
...
var_R04C12_DualLabel_Ermap_Gata1<-R04C12_DualLabel_Ermap_Gata1(var_R04C12_DualLabel_Klf1_Gata1,var_R04C12_Filtered_SampleNames)
invisible(graphics.off())
saveRDS(var_R04C12_DualLabel_Ermap_Gata1, paste0(rds_output,"/var_R04C12_DualLabel_Ermap_Gata1.rds"))
