...
R04C12_DualLabel_Klf1_Ermap <- function(R04C12_DualLabel_Mki67_Epor,R04C12_Filtered_SampleNames) {  # produces 2 color channels and the overlay
    ...
    #Primary inputs:
    seurat_object <- R04C12_DualLabel_Mki67_Epor
...
print("template_function_R04C12_DualLabel_Klf1_Ermap.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_R04C12_DualLabel_Mki67_Epor<-readRDS(paste0(rds_output,"/var_R04C12_DualLabel_Mki67_Epor.rds"))
Input_is_Seurat_count <- 1
#for(item in var_R04C12_DualLabel_Mki67_Epor){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_R04C12_DualLabel_Mki67_Epor<-as.data.frame(var_R04C12_DualLabel_Mki67_Epor)}else{var_R04C12_DualLabel_Mki67_Epor <- var_R04C12_DualLabel_Mki67_Epor}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
...
var_R04C12_DualLabel_Klf1_Ermap<-R04C12_DualLabel_Klf1_Ermap(var_R04C12_DualLabel_Mki67_Epor,var_R04C12_Filtered_SampleNames)
invisible(graphics.off())
saveRDS(var_R04C12_DualLabel_Klf1_Ermap, paste0(rds_output,"/var_R04C12_DualLabel_Klf1_Ermap.rds"))
