...
R04C12_DualLabel_Mki67_Kit <- function(R04C12_DualLabel_Mki67_Ermap,R04C12_Filtered_SampleNames) {  # produces 2 color channels and the overlay
    ...
    #Primary inputs:
    seurat_object <- R04C12_DualLabel_Mki67_Ermap
...
print("template_function_R04C12_DualLabel_Mki67_Kit.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_R04C12_DualLabel_Mki67_Ermap<-readRDS(paste0(rds_output,"/var_R04C12_DualLabel_Mki67_Ermap.rds"))
Input_is_Seurat_count <- 1
#for(item in var_R04C12_DualLabel_Mki67_Ermap){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_R04C12_DualLabel_Mki67_Ermap<-as.data.frame(var_R04C12_DualLabel_Mki67_Ermap)}else{var_R04C12_DualLabel_Mki67_Ermap <- var_R04C12_DualLabel_Mki67_Ermap}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
...
var_R04C12_DualLabel_Mki67_Kit<-R04C12_DualLabel_Mki67_Kit(var_R04C12_DualLabel_Mki67_Ermap,var_R04C12_Filtered_SampleNames)
invisible(graphics.off())
saveRDS(var_R04C12_DualLabel_Mki67_Kit, paste0(rds_output,"/var_R04C12_DualLabel_Mki67_Kit.rds"))
