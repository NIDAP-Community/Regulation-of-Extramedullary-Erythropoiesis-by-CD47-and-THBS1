...
R04C14Cd34neg_CD47KOvsWT_GSEA <- function(R04C14Cd34neg_Filtered_DEG_CD47KOvsWT_Volcano_copied, GSEA_MSigDB_v6_2_with_Orthologs_CCBR_) {
...
# Primary inputs
deg_table = R04C14Cd34neg_Filtered_DEG_CD47KOvsWT_Volcano_copied
...
#image: png
png(
  filename = "R04C14Cd34neg_CD47KOvsWT_GSEA.png",
  width = image_width,
  height = image_height,
  units = "px",
  pointsize = 4,
...
print("template_function_R04C14Cd34neg_CD47KOvsWT_GSEA.R #########################################################################")
...
var_R04C14Cd34neg_CD47KOvsWT_GSEA<-R04C14Cd34neg_CD47KOvsWT_GSEA(var_R04C14Cd34neg_Filtered_DEG_CD47KOvsWT_Volcano_copied,var_GSEA_MSigDB_v6_2_with_Orthologs_CCBR_)
invisible(graphics.off())
saveRDS(var_R04C14Cd34neg_CD47KOvsWT_GSEA, paste0(rds_output,"/var_R04C14Cd34neg_CD47KOvsWT_GSEA.rds"))
