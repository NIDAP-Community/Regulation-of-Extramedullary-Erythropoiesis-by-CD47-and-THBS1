...
R04C14Cd34neg_Filtered_DEG_CD47KOvsWT_Volcano_copied <- function(R04C14Cd34neg_Filtered_DEG) {
    # image: png
...
#CHANGE LOG (NW 2022-03-22): Export significant counts to output log, remove from plot title (~line 160)
    ...
    png(
      filename="R04C14Cd34neg_Filtered_DEG_CD47KOvsWT_Volcano_copied.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_function_R04C14Cd34neg_Filtered_DEG_CD47KOvsWT_Volcano_copied.R #########################################################################")
...
var_R04C14Cd34neg_Filtered_DEG_CD47KOvsWT_Volcano_copied<-R04C14Cd34neg_Filtered_DEG_CD47KOvsWT_Volcano_copied(var_R04C14Cd34neg_Filtered_DEG)
invisible(graphics.off())
saveRDS(var_R04C14Cd34neg_Filtered_DEG_CD47KOvsWT_Volcano_copied, paste0(rds_output,"/var_R04C14Cd34neg_Filtered_DEG_CD47KOvsWT_Volcano_copied.rds"))
