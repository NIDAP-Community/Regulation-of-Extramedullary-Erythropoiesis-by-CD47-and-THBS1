...
R04C14Cd34pos_Filtered_SO <- function(R04C14_Filtered_SO, R04C14_Filtered_MetadataTable, R04C14_Filtered_SampleNames) {
...
print("template_function_R04C14Cd34pos_Filtered_SO.R #########################################################################")
...
var_R04C14Cd34pos_Filtered_SO<-R04C14Cd34pos_Filtered_SO(var_R04C14_Filtered_SO,var_R04C14_Filtered_MetadataTable,var_R04C14_Filtered_SampleNames)
invisible(graphics.off())
saveRDS(var_R04C14Cd34pos_Filtered_SO, paste0(rds_output,"/var_R04C14Cd34pos_Filtered_SO.rds"))
