...
R04C14_Filtered_DEG <- function(R04C14_Filtered_SO,R04C14_Filtered_SampleNames,R04C14_Filtered_MetadataTable) {
    ...
    metadata_table <- R04C14_Filtered_MetadataTable
...
path <- "./rds_output/var_R04C14_Filtered_SO,R04C14_Filtered_SampleNames,R04C14_Filtered_MetadataTable.rds"
        SO <- seurat_object
        print(SO)
...
print("template_function_R04C14_Filtered_DEG.R #########################################################################")
...
var_R04C14_Filtered_DEG<-R04C14_Filtered_DEG(var_R04C14_Filtered_SO,var_R04C14_Filtered_SampleNames,var_R04C14_Filtered_MetadataTable)
invisible(graphics.off())
saveRDS(var_R04C14_Filtered_DEG, paste0(rds_output,"/var_R04C14_Filtered_DEG.rds"))
