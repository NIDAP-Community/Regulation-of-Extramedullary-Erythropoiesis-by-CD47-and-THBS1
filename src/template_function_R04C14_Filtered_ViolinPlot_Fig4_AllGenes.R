...
R04C14_Filtered_ViolinPlot_Fig4_AllGenes <- function(R04C14_Filtered_SO,R04C14_Filtered_MetadataTable) {
...
print("template_function_R04C14_Filtered_ViolinPlot_Fig4_AllGenes.R #########################################################################")
...
var_R04C14_Filtered_ViolinPlot_Fig4_AllGenes<-R04C14_Filtered_ViolinPlot_Fig4_AllGenes(var_R04C14_Filtered_SO,var_R04C14_Filtered_MetadataTable)
invisible(graphics.off())
saveRDS(var_R04C14_Filtered_ViolinPlot_Fig4_AllGenes, paste0(rds_output,"/var_R04C14_Filtered_ViolinPlot_Fig4_AllGenes.rds"))
