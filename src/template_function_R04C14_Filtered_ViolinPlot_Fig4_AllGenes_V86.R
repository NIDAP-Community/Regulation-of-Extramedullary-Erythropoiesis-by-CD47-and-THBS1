# Violin Plot from Seurat Object [scRNASeq][CCBR] (10e8db05-d402-4310-bb56-7e00ee139141): v86
R04C14_Filtered_ViolinPlot_Fig4_AllGenes_V86 <- function(R04C14_Filtered_SO,R04C14_Filtered_MetadataTable) {
...
print("template_function_R04C14_Filtered_ViolinPlot_Fig4_AllGenes_V86.R #########################################################################")
...
var_R04C14_Filtered_ViolinPlot_Fig4_AllGenes_V86<-R04C14_Filtered_ViolinPlot_Fig4_AllGenes_V86(var_R04C14_Filtered_SO,var_R04C14_Filtered_MetadataTable)
invisible(graphics.off())
saveRDS(var_R04C14_Filtered_ViolinPlot_Fig4_AllGenes_V86, paste0(rds_output,"/var_R04C14_Filtered_ViolinPlot_Fig4_AllGenes_V86.rds"))
