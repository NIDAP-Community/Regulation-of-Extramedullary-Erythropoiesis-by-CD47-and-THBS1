# Violin Plot from Seurat Object [scRNASeq][CCBR] (10e8db05-d402-4310-bb56-7e00ee139141): v89
R04C14_Filtered_ViolinPlot_Fig4_AllGenes_V89 <- function(R04C14_Filtered_SO,R04C14_Filtered_MetadataTable) {
    ...
    violins_res <- violinPlot(object = so, assay, slot, genes, group, facet_data = facet_on, facet_by = facet_var, jitter_points, jitter_dot_size)
...
print("template_function_R04C14_Filtered_ViolinPlot_Fig4_AllGenes_V89.R #########################################################################")
...
var_R04C14_Filtered_ViolinPlot_Fig4_AllGenes_V89<-R04C14_Filtered_ViolinPlot_Fig4_AllGenes_V89(var_R04C14_Filtered_SO,var_R04C14_Filtered_MetadataTable)
invisible(graphics.off())
saveRDS(var_R04C14_Filtered_ViolinPlot_Fig4_AllGenes_V89, paste0(rds_output,"/var_R04C14_Filtered_ViolinPlot_Fig4_AllGenes_V89.rds"))
