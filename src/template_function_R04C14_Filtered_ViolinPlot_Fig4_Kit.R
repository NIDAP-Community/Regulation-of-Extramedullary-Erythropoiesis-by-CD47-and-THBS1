...
R04C14_Filtered_ViolinPlot_Fig4_Kit <- function(R04C14_Filtered_SO,R04C14_Filtered_MetadataTable) {
...
print("template_function_R04C14_Filtered_ViolinPlot_Fig4_Kit.R #########################################################################")
...
var_R04C14_Filtered_ViolinPlot_Fig4_Kit<-R04C14_Filtered_ViolinPlot_Fig4_Kit(var_R04C14_Filtered_SO,var_R04C14_Filtered_MetadataTable)
invisible(graphics.off())
saveRDS(var_R04C14_Filtered_ViolinPlot_Fig4_Kit, paste0(rds_output,"/var_R04C14_Filtered_ViolinPlot_Fig4_Kit.rds"))
