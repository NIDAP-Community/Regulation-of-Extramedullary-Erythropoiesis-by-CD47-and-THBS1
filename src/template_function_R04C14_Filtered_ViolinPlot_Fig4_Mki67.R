...
R04C14_Filtered_ViolinPlot_Fig4_Mki67 <- function(R04C14_Filtered_SO,R04C14_Filtered_MetadataTable) {
...
print("template_function_R04C14_Filtered_ViolinPlot_Fig4_Mki67.R #########################################################################")
...
var_R04C14_Filtered_ViolinPlot_Fig4_Mki67<-R04C14_Filtered_ViolinPlot_Fig4_Mki67(var_R04C14_Filtered_SO,var_R04C14_Filtered_MetadataTable)
invisible(graphics.off())
saveRDS(var_R04C14_Filtered_ViolinPlot_Fig4_Mki67, paste0(rds_output,"/var_R04C14_Filtered_ViolinPlot_Fig4_Mki67.rds"))
