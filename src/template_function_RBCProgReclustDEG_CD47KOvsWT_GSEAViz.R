...
RBCProgReclustDEG_CD47KOvsWT_GSEAViz <- function(RBCProg_ReclusteredCellTypes_VolcanobyTreatment_CD47KOvsWT_copied, RBCProgReclustDEG_CD47KOvsWT_GSEAPreranked, RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup, RBCProg_Reclustered_MetadataTable, GSEA_MSigDB_v6_2_with_Orthologs_CCBR_) {
...
## PARAMETERS
    ...
    genescore_df <- RBCProg_ReclusteredCellTypes_VolcanobyTreatment_CD47KOvsWT_copied
    gex_df <- RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup
    metadata_df <- RBCProg_Reclustered_MetadataTable
    gsea_df <- RBCProgReclustDEG_CD47KOvsWT_GSEAPreranked
...
png(filename="RBCProgReclustDEG_CD47KOvsWT_GSEAViz.png", width=(pageWidth+5)*300, height=(pageHeight+5)*300, units="px", pointsize=4, bg="white", res=300, type="cairo") 
print(preview)
...
print("template_function_RBCProgReclustDEG_CD47KOvsWT_GSEAViz.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_RBCProg_ReclusteredCellTypes_VolcanobyTreatment_CD47KOvsWT_copied<-readRDS(paste0(rds_output,"/var_RBCProg_ReclusteredCellTypes_VolcanobyTreatment_CD47KOvsWT_copied.rds"))
Input_is_Seurat_count <- 0
#for(item in var_RBCProg_ReclusteredCellTypes_VolcanobyTreatment_CD47KOvsWT_copied){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_RBCProg_ReclusteredCellTypes_VolcanobyTreatment_CD47KOvsWT_copied<-as.data.frame(var_RBCProg_ReclusteredCellTypes_VolcanobyTreatment_CD47KOvsWT_copied)}else{var_RBCProg_ReclusteredCellTypes_VolcanobyTreatment_CD47KOvsWT_copied <- var_RBCProg_ReclusteredCellTypes_VolcanobyTreatment_CD47KOvsWT_copied}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_RBCProgReclustDEG_CD47KOvsWT_GSEAPreranked<-readRDS(paste0(rds_output,"/var_RBCProgReclustDEG_CD47KOvsWT_GSEAPreranked.rds"))
Input_is_Seurat_count <- 0
#for(item in var_RBCProgReclustDEG_CD47KOvsWT_GSEAPreranked){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_RBCProgReclustDEG_CD47KOvsWT_GSEAPreranked<-as.data.frame(var_RBCProgReclustDEG_CD47KOvsWT_GSEAPreranked)}else{var_RBCProgReclustDEG_CD47KOvsWT_GSEAPreranked <- var_RBCProgReclustDEG_CD47KOvsWT_GSEAPreranked}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup<-readRDS(paste0(rds_output,"/var_RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup.rds"))
Input_is_Seurat_count <- 0
#for(item in var_RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup<-as.data.frame(var_RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup)}else{var_RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup <- var_RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
...
var_RBCProgReclustDEG_CD47KOvsWT_GSEAViz<-RBCProgReclustDEG_CD47KOvsWT_GSEAViz(var_RBCProg_ReclusteredCellTypes_VolcanobyTreatment_CD47KOvsWT_copied,var_RBCProgReclustDEG_CD47KOvsWT_GSEAPreranked,var_RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup,var_RBCProg_Reclustered_MetadataTable,var_GSEA_MSigDB_v6_2_with_Orthologs_CCBR_)
invisible(graphics.off())
saveRDS(var_RBCProgReclustDEG_CD47KOvsWT_GSEAViz, paste0(rds_output,"/var_RBCProgReclustDEG_CD47KOvsWT_GSEAViz.rds"))
