...
RBCProgReclustDEG_ErythVsTcells_GSEAPreranked <- function(ccbr1072_SuppFig7b2, GSEA_MSigDB_v6_2_with_Orthologs_CCBR_) {
...
#image: png
png(
  filename = "RBCProgReclustDEG_ErythVsTcells_GSEAPreranked.png",
  width = image_width,
  height = image_height,
  units = "px",
  pointsize = 4,
...
print("template_function_RBCProgReclustDEG_ErythVsTcells_GSEAPreranked.R #########################################################################")
...
var_RBCProgReclustDEG_ErythVsTcells_GSEAPreranked<-RBCProgReclustDEG_ErythVsTcells_GSEAPreranked(var_ccbr1072_SuppFig7b2,var_GSEA_MSigDB_v6_2_with_Orthologs_CCBR_)
invisible(graphics.off())
saveRDS(var_RBCProgReclustDEG_ErythVsTcells_GSEAPreranked, paste0(rds_output,"/var_RBCProgReclustDEG_ErythVsTcells_GSEAPreranked.rds"))
