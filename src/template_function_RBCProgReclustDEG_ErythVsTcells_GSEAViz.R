...
RBCProgReclustDEG_ErythVsTcells_GSEAViz <- function(ccbr1072_SuppFig7b2, RBCProgReclustDEG_ErythVsTcells_GSEAPreranked, RBCProg_ReclusteredCellTypes_DEG_MouseRNAseq, RBCProg_Reclustered_MetadataTable, GSEA_MSigDB_v6_2_with_Orthologs_CCBR_) {
...
## PARAMETERS
    ...
    genescore_df <- ccbr1072_SuppFig7b2
    gex_df <- RBCProg_ReclusteredCellTypes_DEG_MouseRNAseq
    metadata_df <- RBCProg_Reclustered_MetadataTable
    gsea_df <- RBCProgReclustDEG_ErythVsTcells_GSEAPreranked
...
png(filename="RBCProgReclustDEG_ErythVsTcells_GSEAViz.png", width=(pageWidth+5)*300, height=(pageHeight+5)*300, units="px", pointsize=4, bg="white", res=300, type="cairo") 
print(preview)
...
print("template_function_RBCProgReclustDEG_ErythVsTcells_GSEAViz.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_ccbr1072_SuppFig7b2<-readRDS(paste0(rds_output,"/var_ccbr1072_SuppFig7b2.rds"))
Input_is_Seurat_count <- 0
#for(item in var_ccbr1072_SuppFig7b2){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_ccbr1072_SuppFig7b2<-as.data.frame(var_ccbr1072_SuppFig7b2)}else{var_ccbr1072_SuppFig7b2 <- var_ccbr1072_SuppFig7b2}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_RBCProgReclustDEG_ErythVsTcells_GSEAPreranked<-readRDS(paste0(rds_output,"/var_RBCProgReclustDEG_ErythVsTcells_GSEAPreranked.rds"))
Input_is_Seurat_count <- 0
#for(item in var_RBCProgReclustDEG_ErythVsTcells_GSEAPreranked){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_RBCProgReclustDEG_ErythVsTcells_GSEAPreranked<-as.data.frame(var_RBCProgReclustDEG_ErythVsTcells_GSEAPreranked)}else{var_RBCProgReclustDEG_ErythVsTcells_GSEAPreranked <- var_RBCProgReclustDEG_ErythVsTcells_GSEAPreranked}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_RBCProg_ReclusteredCellTypes_DEG_MouseRNAseq<-readRDS(paste0(rds_output,"/var_RBCProg_ReclusteredCellTypes_DEG_MouseRNAseq.rds"))
Input_is_Seurat_count <- 0
#for(item in var_RBCProg_ReclusteredCellTypes_DEG_MouseRNAseq){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_RBCProg_ReclusteredCellTypes_DEG_MouseRNAseq<-as.data.frame(var_RBCProg_ReclusteredCellTypes_DEG_MouseRNAseq)}else{var_RBCProg_ReclusteredCellTypes_DEG_MouseRNAseq <- var_RBCProg_ReclusteredCellTypes_DEG_MouseRNAseq}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
...
var_RBCProgReclustDEG_ErythVsTcells_GSEAViz<-RBCProgReclustDEG_ErythVsTcells_GSEAViz(var_ccbr1072_SuppFig7b2,var_RBCProgReclustDEG_ErythVsTcells_GSEAPreranked,var_RBCProg_ReclusteredCellTypes_DEG_MouseRNAseq,var_RBCProg_Reclustered_MetadataTable,var_GSEA_MSigDB_v6_2_with_Orthologs_CCBR_)
invisible(graphics.off())
saveRDS(var_RBCProgReclustDEG_ErythVsTcells_GSEAViz, paste0(rds_output,"/var_RBCProgReclustDEG_ErythVsTcells_GSEAViz.rds"))
