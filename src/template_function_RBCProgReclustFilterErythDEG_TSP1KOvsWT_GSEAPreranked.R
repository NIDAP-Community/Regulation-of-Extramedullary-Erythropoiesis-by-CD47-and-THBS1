...
RBCProgReclustFilterErythDEG_TSP1KOvsWT_GSEAPreranked <- function(RBCProg_ReclusteredCellTypes_FilterEryth_DEG_Treatment_Volcano_TSP1KOvsWT_copied, GSEA_MSigDB_v6_2_with_Orthologs_CCBR_) {
...
# Primary inputs
deg_table = RBCProg_ReclusteredCellTypes_FilterEryth_DEG_Treatment_Volcano_TSP1KOvsWT_copied
pathways_database = GSEA_MSigDB_v6_2_with_Orthologs_CCBR_

# Basic parameters
gene_names_column = "Gene"
species = "Mouse"
collections_to_include = c("C7: immunologic signatures","BP: GO biological process","C2: curated gene sets")
...
#image: png
png(
  filename = "RBCProgReclustFilterErythDEG_TSP1KOvsWT_GSEAPreranked.png",
  width = image_width,
  height = image_height,
  units = "px",
  pointsize = 4,
...
print("template_function_RBCProgReclustFilterErythDEG_TSP1KOvsWT_GSEAPreranked.R #########################################################################")
...
var_RBCProgReclustFilterErythDEG_TSP1KOvsWT_GSEAPreranked<-RBCProgReclustFilterErythDEG_TSP1KOvsWT_GSEAPreranked(var_RBCProg_ReclusteredCellTypes_FilterEryth_DEG_Treatment_Volcano_TSP1KOvsWT_copied,var_GSEA_MSigDB_v6_2_with_Orthologs_CCBR_)
invisible(graphics.off())
saveRDS(var_RBCProgReclustFilterErythDEG_TSP1KOvsWT_GSEAPreranked, paste0(rds_output,"/var_RBCProgReclustFilterErythDEG_TSP1KOvsWT_GSEAPreranked.rds"))
