...
RBCProgReclustFilterTcellsDEG_CD47KOvsWT_GSEAPreranked <- function(RBCProg_ReclusteredCellTypes_FilterTCells_DEG_Treatment_Volcano_CD47KOvsWT_copied, GSEA_MSigDB_v6_2_with_Orthologs_CCBR_) {
...
# Primary inputs
deg_table = RBCProg_ReclusteredCellTypes_FilterTCells_DEG_Treatment_Volcano_CD47KOvsWT_copied
...
#image: png
png(
  filename = "RBCProgReclustFilterTcellsDEG_CD47KOvsWT_GSEAPreranked.png",
  width = image_width,
  height = image_height,
  units = "px",
  pointsize = 4,
...
print("template_function_RBCProgReclustFilterTcellsDEG_CD47KOvsWT_GSEAPreranked.R #########################################################################")
...
var_RBCProgReclustFilterTcellsDEG_CD47KOvsWT_GSEAPreranked<-RBCProgReclustFilterTcellsDEG_CD47KOvsWT_GSEAPreranked(var_RBCProg_ReclusteredCellTypes_FilterTCells_DEG_Treatment_Volcano_CD47KOvsWT_copied,var_GSEA_MSigDB_v6_2_with_Orthologs_CCBR_)
invisible(graphics.off())
saveRDS(var_RBCProgReclustFilterTcellsDEG_CD47KOvsWT_GSEAPreranked, paste0(rds_output,"/var_RBCProgReclustFilterTcellsDEG_CD47KOvsWT_GSEAPreranked.rds"))
