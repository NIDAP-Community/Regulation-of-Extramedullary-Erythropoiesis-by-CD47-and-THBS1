...
RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup <- function(RBCProg_ReclusteredCellTypes_SO,RBCProg_ReclusteredCellTypes_SampleNames,RBCProg_ReclusteredCellTypes_MetadataTable) {
...
print("template_function_RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup.R #########################################################################")
...
var_RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup<-RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup(var_RBCProg_ReclusteredCellTypes_SO,var_RBCProg_ReclusteredCellTypes_SampleNames,var_RBCProg_ReclusteredCellTypes_MetadataTable)
invisible(graphics.off())
saveRDS(var_RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup, paste0(rds_output,"/var_RBCProg_ReclusteredCellTypes_DEG_TreatmentGroup.rds"))
