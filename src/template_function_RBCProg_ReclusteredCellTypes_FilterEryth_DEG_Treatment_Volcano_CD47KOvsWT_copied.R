...
RBCProg_ReclusteredCellTypes_FilterEryth_DEG_Treatment_Volcano_CD47KOvsWT_copied <- function(RBCProg_ReclusteredCellTypes_FilterEryth_DEG_Treatment) {
    # image: png
    ...
    #Basic Parameters:
    df <- RBCProg_ReclusteredCellTypes_FilterEryth_DEG_Treatment
    label.col <- "Gene"
    ...
    title <- "Reclustered RBC Progenitor Erythrocytes:  CD47KO vs. WT"
...
#CHANGE LOG (NW 2022-03-22): Export significant counts to output log, remove from plot title (~line 160)
    ...
    png(
      filename="RBCProg_ReclusteredCellTypes_FilterEryth_DEG_Treatment_Volcano_CD47KOvsWT_copied.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_function_RBCProg_ReclusteredCellTypes_FilterEryth_DEG_Treatment_Volcano_CD47KOvsWT_copied.R #########################################################################")
...
var_RBCProg_ReclusteredCellTypes_FilterEryth_DEG_Treatment_Volcano_CD47KOvsWT_copied<-RBCProg_ReclusteredCellTypes_FilterEryth_DEG_Treatment_Volcano_CD47KOvsWT_copied(var_RBCProg_ReclusteredCellTypes_FilterEryth_DEG_Treatment)
invisible(graphics.off())
saveRDS(var_RBCProg_ReclusteredCellTypes_FilterEryth_DEG_Treatment_Volcano_CD47KOvsWT_copied, paste0(rds_output,"/var_RBCProg_ReclusteredCellTypes_FilterEryth_DEG_Treatment_Volcano_CD47KOvsWT_copied.rds"))
