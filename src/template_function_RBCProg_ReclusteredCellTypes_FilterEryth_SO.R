...
RBCProg_ReclusteredCellTypes_FilterEryth_SO <- function(RBCProg_ReclusteredCellTypes_SO, RBCProg_ReclusteredCellTypes_MetadataTable, RBCProg_ReclusteredCellTypes_SampleNames) {
...
library(plotly)
    ...
    values_to_filter <- c("Erythrocytes")
    reduction <- "tsne"
...
print("template_function_RBCProg_ReclusteredCellTypes_FilterEryth_SO.R #########################################################################")
...
var_RBCProg_ReclusteredCellTypes_FilterEryth_SO<-RBCProg_ReclusteredCellTypes_FilterEryth_SO(var_RBCProg_ReclusteredCellTypes_SO,var_RBCProg_ReclusteredCellTypes_MetadataTable,var_RBCProg_ReclusteredCellTypes_SampleNames)
invisible(graphics.off())
saveRDS(var_RBCProg_ReclusteredCellTypes_FilterEryth_SO, paste0(rds_output,"/var_RBCProg_ReclusteredCellTypes_FilterEryth_SO.rds"))
