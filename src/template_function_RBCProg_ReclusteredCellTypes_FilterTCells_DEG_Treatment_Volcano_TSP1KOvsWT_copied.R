...
RBCProg_ReclusteredCellTypes_FilterTCells_DEG_Treatment_Volcano_TSP1KOvsWT_copied <- function(RBCProg_ReclusteredCellTypes_FilterTCells_DEG_Treatment) {
    # image: png
    ...
    #Basic Parameters:
    df <- RBCProg_ReclusteredCellTypes_FilterTCells_DEG_Treatment
    label.col <- "Gene"
    sig.col <- "p_val_TSP1KO_vs_WT"
    pCutoff  = 0.05
    lfc.col <- "avg_log2FC_TSP1KO_vs_WT"
    FCcutoff = 1.0
    ...
    title <- "Reclustered RBC Progenitor T Cells:  TSP1KO vs. WT"
    subtitle <- "p-value <= 0.05 & logFC >= 1.0"
...
#CHANGE LOG (NW 2022-03-22): Export significant counts to output log, remove from plot title (~line 160)
    ...
    png(
      filename="RBCProg_ReclusteredCellTypes_FilterTCells_DEG_Treatment_Volcano_TSP1KOvsWT_copied.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_function_RBCProg_ReclusteredCellTypes_FilterTCells_DEG_Treatment_Volcano_TSP1KOvsWT_copied.R #########################################################################")
...
var_RBCProg_ReclusteredCellTypes_FilterTCells_DEG_Treatment_Volcano_TSP1KOvsWT_copied<-RBCProg_ReclusteredCellTypes_FilterTCells_DEG_Treatment_Volcano_TSP1KOvsWT_copied(var_RBCProg_ReclusteredCellTypes_FilterTCells_DEG_Treatment)
invisible(graphics.off())
saveRDS(var_RBCProg_ReclusteredCellTypes_FilterTCells_DEG_Treatment_Volcano_TSP1KOvsWT_copied, paste0(rds_output,"/var_RBCProg_ReclusteredCellTypes_FilterTCells_DEG_Treatment_Volcano_TSP1KOvsWT_copied.rds"))
