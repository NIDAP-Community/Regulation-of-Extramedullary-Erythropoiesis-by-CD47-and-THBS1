...
RBCProg_ReclusteredCellTypes_FilterTCells_SO <- function(RBCProg_ReclusteredCellTypes_SO, RBCProg_ReclusteredCellTypes_MetadataTable, RBCProg_ReclusteredCellTypes_SampleNames) {
...
library(plotly)
    ...
    cut_off <- 0.5
    category_to_filter <- "mouseRNAseq_main"
    legend_position <- "right"
    values_to_filter <- c("T cells")
    reduction <- "tsne"
...
print("template_function_RBCProg_ReclusteredCellTypes_FilterTCells_SO.R #########################################################################")
...
var_RBCProg_ReclusteredCellTypes_FilterTCells_SO<-RBCProg_ReclusteredCellTypes_FilterTCells_SO(var_RBCProg_ReclusteredCellTypes_SO,var_RBCProg_ReclusteredCellTypes_MetadataTable,var_RBCProg_ReclusteredCellTypes_SampleNames)
invisible(graphics.off())
saveRDS(var_RBCProg_ReclusteredCellTypes_FilterTCells_SO, paste0(rds_output,"/var_RBCProg_ReclusteredCellTypes_FilterTCells_SO.rds"))
