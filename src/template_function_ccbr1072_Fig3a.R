...
ccbr1072_Fig3a <- function(AllCells_CellTypes_SO,AllCells_CellTypes_SampleNames,AllCells_CellTypes_MetadataTable) {
    ...
    Sample_Table <- AllCells_CellTypes_SampleNames ### Double-check!!! Not in use??
...
print("template_function_ccbr1072_Fig3a.R #########################################################################")
...
var_ccbr1072_Fig3a<-ccbr1072_Fig3a(var_AllCells_CellTypes_SO,var_AllCells_CellTypes_SampleNames,var_AllCells_CellTypes_MetadataTable)
invisible(graphics.off())
saveRDS(var_ccbr1072_Fig3a, paste0(rds_output,"/var_ccbr1072_Fig3a.rds"))
