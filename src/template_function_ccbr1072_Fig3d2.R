...
ccbr1072_Fig3d2 <- function(R04C12andC14_Filtered_SO, R04C12andC14_Filtered_MetadataTable, AllCellsCd34PosNeg_DualLabel_SampleNames) {
...
print("template_function_ccbr1072_Fig3d2.R #########################################################################")
...
var_ccbr1072_Fig3d2<-ccbr1072_Fig3d2(var_R04C12andC14_Filtered_SO,var_R04C12andC14_Filtered_MetadataTable,var_AllCellsCd34PosNeg_DualLabel_SampleNames)
invisible(graphics.off())
saveRDS(var_ccbr1072_Fig3d2, paste0(rds_output,"/var_ccbr1072_Fig3d2.rds"))
