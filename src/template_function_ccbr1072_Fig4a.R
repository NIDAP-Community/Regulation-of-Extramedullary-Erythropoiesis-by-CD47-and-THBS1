...
ccbr1072_Fig4a <- function(R04C12andC14_Filtered_SO,R04C12andC14_Filtered_SampleNames) {
    ...
    gene <- c("Cd34","Ly6a","Gata2","Kit","Epor","Mki67")
...
print("template_function_ccbr1072_Fig4a.R #########################################################################")
...
var_R04C12andC14_Filtered_SampleNames <- NULL
...
var_ccbr1072_Fig4a<-ccbr1072_Fig4a(var_R04C12andC14_Filtered_SO,var_R04C12andC14_Filtered_SampleNames)
invisible(graphics.off())
saveRDS(var_ccbr1072_Fig4a, paste0(rds_output,"/var_ccbr1072_Fig4a.rds"))
