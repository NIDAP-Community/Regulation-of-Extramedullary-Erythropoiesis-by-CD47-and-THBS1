...
ccbr1072_Fig4b <- function(R04C12andC14_Filtered_SO,R04C12andC14_Filtered_SampleNames) {
...
print("template_function_ccbr1072_Fig4b.R #########################################################################")
...
var_ccbr1072_Fig4b<-ccbr1072_Fig4b(var_R04C12andC14_Filtered_SO,var_R04C12andC14_Filtered_SampleNames)
invisible(graphics.off())
saveRDS(var_ccbr1072_Fig4b, paste0(rds_output,"/var_ccbr1072_Fig4b.rds"))
