...
ccbr1072_Fig4d <- function(R04C12andC14_Filtered_SO,R04C12andC14_Filtered_SampleNames) {
...
print("template_function_ccbr1072_Fig4d.R #########################################################################")
...
var_ccbr1072_Fig4d<-ccbr1072_Fig4d(var_R04C12andC14_Filtered_SO,var_R04C12andC14_Filtered_SampleNames)
invisible(graphics.off())
saveRDS(var_ccbr1072_Fig4d, paste0(rds_output,"/var_ccbr1072_Fig4d.rds"))
