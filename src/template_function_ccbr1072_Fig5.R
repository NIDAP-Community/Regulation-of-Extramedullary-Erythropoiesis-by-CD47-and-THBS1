...
ccbr1072_Fig5 <- function(R04C12_Filtered_SO,R04C12_Filtered_MetadataTable) {
    ...
    group_subset <- c()
    genes <- c("Gata1","Mki67","Epor","Kit","Klf1","Xpo1","Aqp1","Ranbp2")
...
print("template_function_ccbr1072_Fig5.R #########################################################################")
...
var_ccbr1072_Fig5<-ccbr1072_Fig5(var_R04C12_Filtered_SO,var_R04C12_Filtered_MetadataTable)
invisible(graphics.off())
saveRDS(var_ccbr1072_Fig5, paste0(rds_output,"/var_ccbr1072_Fig5.rds"))
