...
ccbr1072_Fig6a <- function(AllCellsCd34PosNeg_DualLabel_SO, AllCellsCd34PosNeg_DualLabel_MetadataTable, AllCellsCd34PosNeg_DualLabel_SampleNames) {
...
library(plotly)
    ...
    cut_off <- 0.5
    category_to_filter <- "Likely_CellType"
    legend_position <- "right"
    values_to_filter <- c("RBC_Progenitor")
    reduction <- "tsne"
...
print("template_function_ccbr1072_Fig6a.R #########################################################################")
...
var_ccbr1072_Fig6a<-ccbr1072_Fig6a(var_AllCellsCd34PosNeg_DualLabel_SO,var_AllCellsCd34PosNeg_DualLabel_MetadataTable,var_AllCellsCd34PosNeg_DualLabel_SampleNames)
invisible(graphics.off())
saveRDS(var_ccbr1072_Fig6a, paste0(rds_output,"/var_ccbr1072_Fig6a.rds"))
