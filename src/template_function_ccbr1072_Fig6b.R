...
ccbr1072_Fig6b <- function(RBCProg_ReclusteredCellTypes_SO,RBCProg_ReclusteredCellTypes_SampleNames,RBCProg_ReclusteredCellTypes_MetadataTable) {
...
print("template_function_ccbr1072_Fig6b.R #########################################################################")
...
var_ccbr1072_Fig6b<-ccbr1072_Fig6b(var_RBCProg_ReclusteredCellTypes_SO,var_RBCProg_ReclusteredCellTypes_SampleNames,var_RBCProg_ReclusteredCellTypes_MetadataTable)
invisible(graphics.off())
saveRDS(var_ccbr1072_Fig6b, paste0(rds_output,"/var_ccbr1072_Fig6b.rds"))
