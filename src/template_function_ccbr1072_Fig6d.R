...
ccbr1072_Fig6d <- function(RBCProg_Reclustered_SO, RBCProg_Reclustered_MetadataTable, AllCellsCd34PosNeg_DualLabel_SampleNames) {
...
library(plotly)
    ...
    seurat_object <- RBCProg_Reclustered_SO
...
print("template_function_ccbr1072_Fig6d.R #########################################################################")
...
var_ccbr1072_Fig6d<-ccbr1072_Fig6d(var_RBCProg_Reclustered_SO,var_RBCProg_Reclustered_MetadataTable,var_AllCellsCd34PosNeg_DualLabel_SampleNames)
invisible(graphics.off())
saveRDS(var_ccbr1072_Fig6d, paste0(rds_output,"/var_ccbr1072_Fig6d.rds"))
