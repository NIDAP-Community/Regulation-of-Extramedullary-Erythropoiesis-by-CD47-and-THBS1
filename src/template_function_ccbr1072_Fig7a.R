...
ccbr1072_Fig7a <- function(RBCProg_ReclusteredCellTypes_SO,RBCProg_ReclusteredCellTypes_SampleNames) {
...
print("template_function_ccbr1072_Fig7a.R #########################################################################")
...
var_ccbr1072_Fig7a<-ccbr1072_Fig7a(var_RBCProg_ReclusteredCellTypes_SO,var_RBCProg_ReclusteredCellTypes_SampleNames)
invisible(graphics.off())
saveRDS(var_ccbr1072_Fig7a, paste0(rds_output,"/var_ccbr1072_Fig7a.rds"))
