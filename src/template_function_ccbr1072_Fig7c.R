...
ccbr1072_Fig7c <- function(RBCProg_ReclusteredCellTypes_SO,RBCProg_ReclusteredCellTypes_SampleNames) {
...
print("template_function_ccbr1072_Fig7c.R #########################################################################")
...
var_ccbr1072_Fig7c<-ccbr1072_Fig7c(var_RBCProg_ReclusteredCellTypes_SO,var_RBCProg_ReclusteredCellTypes_SampleNames)
invisible(graphics.off())
saveRDS(var_ccbr1072_Fig7c, paste0(rds_output,"/var_ccbr1072_Fig7c.rds"))
