...
ccbr1072_Fig7d <- function(RBCProg_ReclusteredCellTypes_SO,RBCProg_ReclusteredCellTypes_SampleNames) {
    ...
    gene <- c("Ranbp2","Ranbp2","Ranbp2","Ranbp2","Ranbp2","Ranbp2")
...
print("template_function_ccbr1072_Fig7d.R #########################################################################")
...
var_ccbr1072_Fig7d<-ccbr1072_Fig7d(var_RBCProg_ReclusteredCellTypes_SO,var_RBCProg_ReclusteredCellTypes_SampleNames)
invisible(graphics.off())
saveRDS(var_ccbr1072_Fig7d, paste0(rds_output,"/var_ccbr1072_Fig7d.rds"))
