...
ccbr1072_SuppFig4a <- function(AllCells_CellTypes_SO,AllCells_CellTypes_SampleNames) {
    ...
    gene <- c("Aqp1","Atxn1","Cd34","Cd38","Eng","Epb42")
...
print("template_function_ccbr1072_SuppFig4a.R #########################################################################")
...
var_ccbr1072_SuppFig4a<-ccbr1072_SuppFig4a(var_AllCells_CellTypes_SO,var_AllCells_CellTypes_SampleNames)
invisible(graphics.off())
saveRDS(var_ccbr1072_SuppFig4a, paste0(rds_output,"/var_ccbr1072_SuppFig4a.rds"))
