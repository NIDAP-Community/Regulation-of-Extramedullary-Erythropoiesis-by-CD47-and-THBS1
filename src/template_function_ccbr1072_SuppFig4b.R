...
ccbr1072_SuppFig4b <- function(AllCells_CellTypes_SO,AllCells_CellTypes_SampleNames) {
    ...
    gene <- c("Epor","Ermap","Gata1","Gata2","Gypa","Kit")
...
print("template_function_ccbr1072_SuppFig4b.R #########################################################################")
...
var_ccbr1072_SuppFig4b<-ccbr1072_SuppFig4b(var_AllCells_CellTypes_SO,var_AllCells_CellTypes_SampleNames)
invisible(graphics.off())
saveRDS(var_ccbr1072_SuppFig4b, paste0(rds_output,"/var_ccbr1072_SuppFig4b.rds"))
