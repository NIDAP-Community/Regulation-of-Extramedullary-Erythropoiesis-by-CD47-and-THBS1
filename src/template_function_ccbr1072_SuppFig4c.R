...
ccbr1072_SuppFig4c <- function(AllCells_CellTypes_SO,AllCells_CellTypes_SampleNames) {
    ...
    gene <- c("Klf1","Klf2","Ly6a","Mki67","Myc","Prom1")
...
print("template_function_ccbr1072_SuppFig4c.R #########################################################################")
...
var_ccbr1072_SuppFig4c<-ccbr1072_SuppFig4c(var_AllCells_CellTypes_SO,var_AllCells_CellTypes_SampleNames)
invisible(graphics.off())
saveRDS(var_ccbr1072_SuppFig4c, paste0(rds_output,"/var_ccbr1072_SuppFig4c.rds"))
