...
ccbr1072_SuppFig4e <- function(AllCells_CellTypes_SO,AllCells_CellTypes_SampleNames) {
    ...
    gene <- c("Tmem56","Trim10","Xpo1","Xpo1","Xpo1","Xpo1")
...
print("template_function_ccbr1072_SuppFig4e.R #########################################################################")
...
var_ccbr1072_SuppFig4e<-ccbr1072_SuppFig4e(var_AllCells_CellTypes_SO,var_AllCells_CellTypes_SampleNames)
invisible(graphics.off())
saveRDS(var_ccbr1072_SuppFig4e, paste0(rds_output,"/var_ccbr1072_SuppFig4e.rds"))
