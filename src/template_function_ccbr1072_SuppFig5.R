# Violin Plot from Seurat Object [scRNASeq][CCBR] (10e8db05-d402-4310-bb56-7e00ee139141): v94
ccbr1072_SuppFig5 <- function(AllCells_CellTypes_SO,AllCells_CellTypes_MetadataTable) {
    ...
    #Plot Parameters:
    genes <- c("Ermap","Mki67","Kit","Gata1","Klf1","Epor","Cd34","Aqp1","Gypa")
    group <- 'SCT_snn_res_0_4'
    facet_on <- FALSE
...
print("template_function_ccbr1072_SuppFig5.R #########################################################################")
...
var_ccbr1072_SuppFig5<-ccbr1072_SuppFig5(var_AllCells_CellTypes_SO,var_AllCells_CellTypes_MetadataTable)
invisible(graphics.off())
saveRDS(var_ccbr1072_SuppFig5, paste0(rds_output,"/var_ccbr1072_SuppFig5.rds"))
